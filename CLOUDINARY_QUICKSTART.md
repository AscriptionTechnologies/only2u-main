# 🚀 Cloudinary Quick Start Guide _(Deprecated)_

> NOTE: Cloudinary instructions are retained for reference only. The live project now uses Bunny Stream. See `BUNNY_STREAM_SETUP.md` for the up-to-date steps.
