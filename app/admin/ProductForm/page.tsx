...
type Product = {
  ...
  replacement_policy_days?: number | null;
  vendor_id?: string;
  vendor_name?: string;
  alias_vendor?: string;
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Number of days within which the product can be replaced
                  </p>
                </div>
                ...
                <div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            tax_type: (e.target.value || null) as "IGST" | "SGST" | null,
                          })
                        }
                        className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#F53F7A] focus:border-transparent"
                      >
                        ...
                        <option value="SGST">SGST (Intra-state)</option>
                      </select>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    IGST is used for inter-state transactions, SGST for intra-state transactions
                  </p>
                </div>
