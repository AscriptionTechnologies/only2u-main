...
DROP TABLE IF EXISTS influencer_post_likes CASCADE;
DROP TABLE IF EXISTS influencer_follows CASCADE;
...
SELECT 'Influencer profiles system created successfully' AS status;
