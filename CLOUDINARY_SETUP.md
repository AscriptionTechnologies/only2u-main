# Cloudinary Setup Guide _(Deprecated)_

> NOTE: Cloudinary has been replaced with Bunny Stream + Bunny Storage. See `BUNNY_STREAM_SETUP.md` for the current instructions.
